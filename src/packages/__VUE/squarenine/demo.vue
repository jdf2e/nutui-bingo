...
const { createDemo } = createComponent("lucknine");
export default createDemo({
  setup() {
    ...
    const prizeId: any = ref();
    const cardImg: any = ref('//img11.360buyimg.com/imagetools/jfs/t1/73511/35/17197/9388/613852cdE75dc6822/ddb31e0f3cfdcb81.png');
    const click = () => {
      prizeId.value=2
    };
    return {
