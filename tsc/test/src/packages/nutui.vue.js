...
function install(app) {
    const packages = [Luckdraw, Luckmarquee, Lucknine, Luckscratch, Luckgiftbox, lottoRoll, Luckeggs, Luckshake, Dollmachine];
...
export { install, Luckdraw, Luckmarquee, Lucknine, Luckscratch, Luckgiftbox, lottoRoll, Luckeggs, Luckshake, Dollmachine };
